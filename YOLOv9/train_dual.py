...
# python /home/jiachen/nuImages/YOLOv9/train_dual.py --workers 8 --device 0 --batch 4 --data /home/jiachen/nuImages/YOLOv9/data/nuimages.yaml --img 640 --cfg /home/jiachen/nuImages/YOLOv9/models/detect/yolov9-e.yaml --weights '' --name yolov9-e --hyp hyp.scratch-high.yaml --min-items 0 --epochs 300 --close-mosaic 15
